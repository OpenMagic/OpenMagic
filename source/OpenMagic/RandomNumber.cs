...
namespace OpenMagic
{
    ...
    public static class RandomNumber
    {
        ...
        /// </returns>
        public static byte NextByte(byte minValue, byte maxValue) => (byte)NextInt(minValue, maxValue);
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static char NextChar(char minValue, char maxValue) => (char)NextInt(minValue, maxValue);

        /// <summary>
        ///     Returns a random <see cref="decimal" />.
        /// </summary>
        public static decimal NextDecimal() => NextDecimal(decimal.MinValue, decimal.MaxValue);

        /// <summary>
        ///     Returns a random nullable <see cref="decimal" />.
        /// </summary>
        public static decimal? NextNullableDecimal() => RandomBoolean.Next() ? NextDecimal() : null;
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static decimal NextDecimal(decimal minValue, decimal maxValue) => (decimal)NextDouble((double)minValue, (double)maxValue);
        ...
        /// </summary>
        public static float NextFloat() => NextFloat(float.MinValue, float.MaxValue);
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static float NextFloat(float minValue, float maxValue) => (float)NextDouble(minValue, maxValue);

        /// <summary>
        ///     Returns a random <see cref="int" />.
        /// </summary>
        public static int NextInt() => NextInt(int.MinValue, int.MaxValue);
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static long NextLong(long minValue, long maxValue) => (long)NextDouble(minValue, maxValue);
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static sbyte NextSByte(sbyte minValue, sbyte maxValue) => (sbyte)NextInt(minValue, maxValue);

        /// <summary>
        ///     Returns a random <see cref="short" />.
        /// </summary>
        public static short NextShort() => NextShort(short.MinValue, short.MaxValue);
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static short NextShort(short minValue, short maxValue) => (short)NextInt(minValue, maxValue);

        /// <summary>
        ///     Returns a random <see cref="uint" />.
        /// </summary>
        public static uint NextUInt() => NextUInt(uint.MinValue, uint.MaxValue);
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static uint NextUInt(uint minValue, uint maxValue) => (uint)NextDouble(minValue, maxValue);
        ...
        ///     includes minValue but not maxValue. If minValue equals maxValue, minValue is returned.
        /// </returns>
        public static ulong NextULong(ulong minValue, ulong maxValue) => (ulong)NextDouble(minValue, maxValue);

        /// <summary>
        ///     Returns a random <see cref="ushort" />.
        /// </summary>
        public static ushort NextUShort() => NextUShort(ushort.MinValue, ushort.MaxValue);
