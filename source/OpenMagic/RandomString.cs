...
namespace OpenMagic
{
    ...
    public class RandomString
    {
        ...
        /// <summary>
        ///     Get a random string between 1 and 25 characters long with <paramref name="formatItems" /> format items.
        /// </summary>
        ...
        public static string NextFormat(int formatItems)
        {
            if (formatItems < 1)
            {
                var exception = new ArgumentOutOfRangeException(nameof(formatItems), "Number of format items must be 1 or more.");
